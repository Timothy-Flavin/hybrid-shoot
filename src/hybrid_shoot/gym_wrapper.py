...
class HybridShootEnv(gym.Env):
    ...
    def render(self):
        ...
        def to_screen(x, y):
            return (int(x / self.map_size * self.window_size), 
        ...
        if self.last_action is not None:
            ...
            if 0 <= jam_idx < self.n_enemies:
                ...
                idx = int(jam_idx) * 3
                tx, ty, talive = self.prev_state[idx], self.prev_state[idx+1], self.prev_state[idx+2]
                ...
                pygame.draw.circle(canvas, (0, 0, 255), t_pos, 20, 2) # Width 2 = unfilled
